...
//FUNCOES
	...
	function conectaBanco(){
		mysql_connect('mysql.hostinger.com.br','u725950134_agnit','45d-e6e6-t1t0') or die("Falha ao se conectar ao banco. Verifique se os dados de conexão estão corretos.");
